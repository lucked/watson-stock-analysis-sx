...
(function() {
  ...
  function loadSelectedProblem() {
    var path = "http://spandan.iiitb.ac.in/StockXchange/rest/get_stocks_watson";
    ...
    finaldata.subject = "StockXchange: Best buy by watson";
    
    col2.key = "stock_current";
    col2.full_name = "current price";
    col2.type = "NUMERIC";
    col2.is_objective = true;
    col2.goal = "MIN";
    col.push(col2);
    col2 = {};


    col2.key = "stock_day_high";
    col2.full_name = "DAY HIGH";
    col2.type = "NUMERIC";
    col2.is_objective = false;
    col2.goal ="MAX";
    col.push(col2);
    col2 = {};


    col2.key = "stock_day_low";
    col2.full_name = "DAY LOW";
    col2.type = "NUMERIC";
    col2.is_objective = false;
    col2.goal = "MAX";
    col.push(col2);
    ...
    col2.key = "diff";
    col2.full_name = "CLOSENESS TO DAY LOW";
    col2.type = "NUMERIC";
    col2.is_objective = "true";
    col2.goal = "MIN";
    col.push(col2);
    ...
    $.getJSON(path, function(data) {
      ...
      $.each(data, function(i,field){
        if(field.stock_day_low != 0){

          temp.stock_current = field.stock_current;
          temp.stock_day_low = field.stock_day_low;
          temp.stock_day_high = field.stock_day_high;
          temp.stock_sold = field.stock_sold;
          temp.diff = field.diff;
          console.log(temp.stock_name);
          
          
          temp0.key = String(field.stock_id);
          temp0.name = field.stock_name;
          temp0.values = temp;
      ...
      $('.problemText').val(JSON.stringify(finaldata, null, 2)).change();
